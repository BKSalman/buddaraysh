...
impl<BackendData: Backend> PointerTarget<Buddaraysh<BackendData>> for FocusTarget {
    fn enter(
        &self,
    ...
    fn frame(&self, seat: &Seat<Buddaraysh<BackendData>>, data: &mut Buddaraysh<BackendData>) {
        match self {
...
impl<BackendData: Backend> KeyboardTarget<Buddaraysh<BackendData>> for FocusTarget {
    fn enter(
        &self,
        seat: &Seat<Buddaraysh<BackendData>>,
        data: &mut Buddaraysh<BackendData>,
